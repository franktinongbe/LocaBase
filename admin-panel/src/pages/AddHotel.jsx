...
const AddHotel = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setErrorMessage('');
    try {
      await axios.post('https://locabase-api.onrender.com/api/hotels', form, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`
        }
      });
      ...
      console.error(error);
      setErrorMessage("❌ Erreur lors de l'ajout de l'hôtel.");
    }
  };
    ...
    <div className="container-lg mt-5">
      <div className="bg-white p-4 rounded shadow-sm">
        <div className="text-center mb-4">
          <h2 className="fw-bold text-primary">🏨 Ajouter un Hôtel</h2>
          <p className="text-muted">Ajoutez les informations nécessaires pour enregistrer un nouvel hôtel.</p>
        </div>
