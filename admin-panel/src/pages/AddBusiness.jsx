...
const AddBusiness = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setErrorMessage('');
    try {
      await axios.post('https://locabase-api.onrender.com/api/businesses', form, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`
        }
      });
      alert('🏬 Business ajouté avec succès !');
      setForm({
        nom: '',
        adresse: '',
        ville: '',
      ...
      console.error(error);
      setErrorMessage("❌ Erreur lors de l'ajout du business.");
    }
  };
    ...
    <div className="container-lg mt-5">
      <div className="bg-white p-4 rounded shadow-sm">
        <div className="text-center mb-4">
          <h2 className="fw-bold text-primary">🏬 Ajouter un Business</h2>
          <p className="text-muted">Remplissez les informations ci-dessous pour enregistrer un nouveau business ou service.</p>
        </div>
